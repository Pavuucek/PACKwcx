...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
  ...
  <xsl:template match="Projects" mode="ProjectOverview">
    ...
    <table>
      <tr>
        ...
        <th _locID="PathTableHeader">Cesta</th>
        <th _locID="ErrorsTableHeader">Chyby</th>
        <th _locID="WarningsTableHeader">Upozornění</th>
        <th _locID="MessagesTableHeader">Zprávy</th>
      </tr>
              ...
              <a>
                ...
                <xsl:choose>
                  <xsl:when test="@ProjectDisplayName = ''">
                    <span _locID="OverviewSolutionSpan">Řešení</span>
                  </xsl:when>
                  <xsl:otherwise>
    ...
    <tr>
      ...
      <td class="messageCell">
        ...
        <a _locID="ShowAdditionalMessages" href="#">
          ...
          Zobrazit <xsl:value-of select="@MessageCount"/> další zprávy
        </a>
      </td>
    </tr>
  </xsl:template>
    ...
    <tr style="display: none">
      ...
      <td class="messageCell">
        ...
        <a _locID="HideAdditionalMessages" href="#">
          ...
          Skrýt <xsl:value-of select="@MessageCount"/> další zprávy
        </a>
      </td>
    </tr>
  </xsl:template>
  ...
  <xsl:template match="Projects" mode="ProjectDetails">
    ...
    <xsl:for-each select="Project">
      ...
      <xsl:choose>
        <xsl:when test="@ProjectDisplayName = ''">
          <h3 _locID="ProjectDisplayNameHeader">Řešení</h3>
        </xsl:when>
        <xsl:otherwise>
          <h3>
            <xsl:value-of select="@ProjectDisplayName"/>
      ...
      <table>
        <tr>
          ...
          <th></th>
          <th class="messageCell" _locID="MessageTableHeader">Zpráva</th>
        </tr>
              ...
              <xsl:choose>
                <xsl:when test="@ProjectDisplayName = ''">
                  <td class="messageCell" _locID="NoMessagesRow2">
                    Řešení nezpůsobuje protokolování žádných zpráv.
                  </td>
                </xsl:when>
                <xsl:otherwise>
                  <td class="messageCell" _locID="NoMessagesRow">
                    <xsl:value-of select="@ProjectDisplayName"/> nezpůsobuje protokolování žádných zpráv.
                  </td>
                </xsl:otherwise>
              </xsl:choose>
            </tr>
    ...
    <html>
      ...
      <body>
        <h1 _locID="ConversionReport">
          Protokol migrace - <xsl:value-of select="Properties/Property[@Name='Solution']/@Value"/>
        </h1>

        <div id="content">
          <h2 _locID="OverviewTitle">Přehled</h2>
          ...
          <h2 _locID="SolutionAndProjectsTitle">Řešení a projekty</h2>
